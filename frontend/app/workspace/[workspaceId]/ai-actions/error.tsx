 ...
 * already handles expected API errors (401/403/404) inline, so only a
 * genuine bug/network failure reaches this boundary.
 */
export default function AiActionsError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
