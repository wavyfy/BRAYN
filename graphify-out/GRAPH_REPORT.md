...
## Corpus Check
- Corpus is ~13,390 words - fits in a single context window. You may not need a graph.

## Summary
- 740 nodes · 927 edges · 51 communities (40 shown, 11 thin omitted)
...
Cohesion: 0.06
Nodes (26): logger, createEvent(), CreateEventInput, DomainEvent, EventBus, app, bus, event (+18 more)
...
Cohesion: 0.12
Nodes (13): users, userService, UserController, client, created, existing, initialSelect, insertChain (+5 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (24): created_at, id, name, updated_at, default, name, notNull, primaryKey (+16 more)
...
Cohesion: 0.15
Nodes (10): AiModule, AutomationModule, ConversationModule, CustomerIntelligenceModule, DatabaseModule, IdentityResolutionModule, IntegrationModule, IntelligenceEnginesModule (+2 more)
...
Cohesion: 0.22
Nodes (9): loadConfiguration(), config, originalEnv, Env, envSchema, REQUIRED_IN_PRODUCTION, warnOnMissingProductionSecrets(), initSentry() (+1 more)
...
## Knowledge Gaps
- **408 isolated node(s):** `Obsidian`, `Ponytail`, `Agent Browser`, `pr-review-toolkit`, `BRAYN (README)` (+403 more)
...
- **Why does `WorkspaceModule` connect `Community 5` to `Community 12`, `Community 15`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `StructuredLoggerService` connect `Community 0` to `Community 17`, `Community 5`, `Community 4`, `Community 20`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `DatabaseService` connect `Community 27` to `Community 5`, `Community 15`, `Community 17`, `Community 20`, `Community 24`, `Community 31`?**
